...
\subsection{Models}
We experiment with four PLM variants from three PLMs families: BERT \cite{bert}, BERT whole-word-masking \am{cite?}, RoBERTa \cite{roberta} and ALBERT \cite{albert}, each with two of their  size variants.\footnote{For ALBERT we use the smallest and largest versions.}
...
Overall, after the filters\am{filtering}, we are left with @@ tuples.\am{add @@ percent as well?}
