...
\node[right] at (-1.7,-2.2) {\tiny \textit{Homeland} premiered on \textsc{[MASK]}};
...
\node[] at (0, 0.4) [fontscale=0.1, text=red!60] {\tiny Inconsistent Prediction};
...
\node[right] at (2.3,-2.2) {\tiny \textit{Seinfeld} premiered on \textsc{[MASK]}};
