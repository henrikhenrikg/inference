...
% text
\node[] at (0,0) {\tiny \textit{Homeland} was released on \textsc{[MASK]}};
...
\node[] at (0,-2.2) {\tiny \textit{Homeland} aired on \textsc{[MASK]}};
...
% Consistent
\node[] at (4,0) {\tiny \textit{Seinfeld} was released on \textsc{[MASK]}};
...
\node[] at (4,-2.2) {\tiny \textit{Seinfeld} aired on \textsc{[MASK]}};
