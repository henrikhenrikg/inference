...
\node at (0, -2.7) {\textit{Homeland} originally aired on [MASK]};
\node at (0, -3.1) {\textit{Homeland} premiered on [MASK]};
...
\node at (0, -3.9) {\textit{Seinfeld} originally aired on [MASK]};
\node at (0, -4.3) {\textit{Seinfeld}  premiered on [MASK]};
...
\draw [-, Cerulean] ($ (leftl) - (0,2.5) $) -- ($ (leftr) - (0,2.5) $);
...
\draw [-, Cerulean] ($ (leftl) - (0,3.9) $) -- ($ (leftr) - (0,3.9) $);
...
\draw [-, Cerulean] ($ (rightl) - (1,2.5) $) -- ($ (rightr) - (1,2.5) $);
...
\draw [-, Cerulean] ($ (rightl) - (1,3.9) $) -- ($ (rightr) - (1,3.9) $);
