...
% \yg{sec 3 should be either all in page 2, or all in page 3.}
...
\enote{hs}{it's really lame to define a central term in a
  footnote -- also is the definition correct? one of subject
  or object (or only object?) has to be MASK?}
