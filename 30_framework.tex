...
% \nk{Earlier you say consistent = "it makes the same prediction". According to that definition N-M would be inconsistent but factually incorrect.} 
...
% \nk{Is this a standard term used? Do people know what we mean?}, such violation can be measured in a many-to-many scenario. 
% We thus separate the determinism term from consistency.
...
% \nk{I usually try to put everything necessary for a reader to understand a figure inside the caption, even though that means repeating what has been said in 3.2. So I would mention what D, P, R is and what we do with it. What do you think?}}
\label{fig:framework}
% \vspace{-6mm}
\end{figure}
