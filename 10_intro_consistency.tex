...
A desirable property of a good language understanding model is consistency. That is, making consistent decisions in semantically equivalent contexts, reflecting a systematic ability to generalize in face \am{the face? facing?} of language variability.
