...
While consistency is important to many tasks, nothing in the training process explicitly targets it. But, perhaps the unsupervised training signal in large PLMs such as BERT or RoBERTa \cite{bert,roberta} \am{is} sufficient to induce consistency, which can then be transferred to downstream tasks? 
