...
As we discussed earlier, consistency is a crucial component of many NLP system \cite{du2019consistent,consistent-qa,denis2009global,kryscinski2020evaluating} and gaining this skill from a PLM would be extremely beneficial and have the potential to excess\yg{?} specialized solutions for downstream tasks.
Indeed, there is an ongoing discussion about the meaning\yg{?} capabilities of PLMs, that are trained solely on form (texts) \cite{bender2020climbing} \sr{``meaning capabiltiies" is unclear. ``The ability to acquire understanding of ``meaning" from raw text signal alone"? but generally I think this paragraph doesn't say much, and the quote of Bender can be incorporated in the intro.}.
