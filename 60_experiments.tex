...
An interesting observation  is the clear superiority of
...
the focused\am{I don't like the word "focused"} training on it (besides from the book corpus) was likely to make the BERT models incorporate it better.
As such, it is unclear if models such as GPT-3 \cite{gpt3},
or other future models that solely train on more data with
more parameters are likely to be more consistent.
