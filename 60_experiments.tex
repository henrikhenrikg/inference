...
consistency. \yenew{We hypothesize this result is caused by the different sources of training data: although Wikipedia is part of the training data for all models we consider for BERT it is the main data source, but for RoBERTa and ALBERT it is only a small portion. Thus, when using additional data, some of the facts may be forgotten, or contradicted in the other corpora, leading to diminish in knowledge, and consistency behavior.} 
