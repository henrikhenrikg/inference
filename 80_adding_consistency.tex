...
Notably, these improvements arises from only three relations that are not part of the test set.\yg{This is not clear: (a) it sounds as if you say '3 are not part of the set and others are part of the set'; (b) it is not clear why this is impressive. Try to make this point clearer. }
