...
\enote{hs}{this sentence:
``that
is, to what extent do such probes uncover generalizable
capabilities of a model, and how indicative they are of
factual knowledge''
 seems like a nonsequitur to me: not clear
  what ``such probes''
refers to and factual knowledge hasn't been mentioned
}
